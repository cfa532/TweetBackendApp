...
((request, args)=>{
    ...
    try {
        ...
        if (nodeId !== hostId) {
            ...
            lapi.Debug("Tweed delete_comment: local commentCount=%s, commentId=%s", String(commentCount), commentId)
        ...
        lapi.Error("Tweed Error delete_comment: %s, request=%s", e, JSON.stringify(request))
        return wrapError(e)
    }
})(request, args)