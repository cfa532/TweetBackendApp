((request, args) => {
    try {
        ...
        let ret = {
            ...
            version: 38,  // set it larger than defaultConfig.versionName in build.gradle to force upgrade.
            packageId: mid,     // has to match the mid of installation package created by upload_package.js
